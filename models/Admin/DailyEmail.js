...
// Define a model
const DailyEmail = sequelize.define('daily_email_clicks', {
  id: {
...
DailyEmail.sync()
  .then(() => {
    // console.log('DailyEmail table created successfully!');
  })
  .catch(error => {
    console.error('Error creating DailyEmail table:', error);
