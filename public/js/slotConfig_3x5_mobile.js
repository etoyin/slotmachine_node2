...
var slotConfig_3x5 = {
    ...
    minWin: 10000,    //Modified          // to show big, mega, huge popup
    ...
    createControls: function (scene, slotControls){
        ...
        */
        ...
        slotControls.totalBetSumText = scene.add.bitmapText(scene.centerX + 801, scene.centerY + 406, 'gameFont_1', slotControls.getTotalBet(), 63, 1).setOrigin(0.5);
        ...
        slotControls.autoSpinText = scene.add.bitmapText(scene.centerX + 122, scene.centerY + 263 + 220, 'gameFont_2', 'AUTO', 37, 1).setOrigin(0.5);
        ...
        slotControls.autoSpinText1 = scene.add.bitmapText(scene.centerX + 122, scene.centerY + 290 + 220, 'gameFont_2', 'SPIN', 37, 1).setOrigin(0.5);
